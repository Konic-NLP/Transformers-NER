...
parser.add_argument('--raw_file', type=str, default='data/guwen.txt', help='path to the raw data file')
...
parser.add_argument('--transformer_name', type=str, default='SIKU-BERT/sikubert', help='name of the pretrained transformer model')
